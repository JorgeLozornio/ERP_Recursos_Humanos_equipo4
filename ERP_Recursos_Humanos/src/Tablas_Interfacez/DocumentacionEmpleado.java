...
String ruta_archivo = "";
   ...
   Tabla_Pdf tpdf;
    ...
    public DocumentacionEmpleado(Connection c, String u) throws SQLException {
        ...
        Tabla_Pdf tpdf2 =new Tabla_Pdf(con);
        t = tu;
        tpdf=tpdf2;
        initComponents();
        ...
        tpdf.visualizar_PdfVO(tbDoc, inicio, fin);
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 200, 80, 30));
        ...
        getContentPane().add(txfDocumento, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 210, 135, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 100, 560, 280));
        ...
        getContentPane().add(jLabelBarra, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 960, -1));
    ...
    private void lblInsertarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblInsertarMouseClicked
        ...
        if (txfNombre.getText().isEmpty() || txfDocumento.getText().isEmpty() || "".equals(dcEntrega.getDate()) || dcEntrega.getDate()==null || cbEmpleado.getSelectedIndex() == -1 || cbEstatus.getSelectedIndex() == -1) {
            ...
            int seleccionEmpleado = cbEmpleado.getSelectedIndex();
             Modelo_DocumentacionEmpleado DocEmp = new Modelo_DocumentacionEmpleado();
                ...
                ruta_archivo=txfDocumento.getText();
        ...
        if (ruta_archivo.trim().length() != 0) {
            ...
            input.read(pdf);
            DocEmp.setDocumento(pdf);
        } catch (IOException ex) {
            DocEmp.setDocumento(null);
    ...
    private void lblActualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblActualizarMouseClicked
        // TODO add your handling code here:
       if (txfNombre.getText().isEmpty()  || "".equals(dcEntrega.getDate()) || dcEntrega.getDate()==null || cbEmpleado.getSelectedIndex() == -1 || cbEstatus.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Error: No dejes campos vacios");
        } else {
            int seleccionEstatus = cbEstatus.getSelectedIndex();
            int seleccionEmpleado = cbEmpleado.getSelectedIndex();
    ...
    private void lblEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEliminarMouseClicked
        // TODO add your handling code here:
        if (txfNombre.getText().isEmpty() || "".equals(dcEntrega.getDate()) || dcEntrega.getDate()==null || cbEstatus.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Error: No dejes campos vacios");
        } else {
...
t.eliminar(id);
    ...
    private void txfBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txfBuscarKeyReleased
        // TODO add your handling code here:
        tpdf.visualizar_Pdf_Individual(tbDoc,txfBuscar.getText());
    ...
    private void tbDocMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDocMouseClicked
        // TODO add your handling code here:
        int column = tbDoc.getColumnModel().getColumnIndexAtX(evt.getX());
        int row = evt.getY() / tbDoc.getRowHeight();
       
        if (row < tbDoc.getRowCount() && row >= 0 && column < tbDoc.getColumnCount() && column >= 0) {
           int id = Integer.parseInt(tbDoc.getValueAt(tbDoc.getSelectedRow(), 0).toString());
                 DocumentacionEmpleadoDAO DAO = new DocumentacionEmpleadoDAO (this.con);
        Modelo_DocumentacionEmpleado docEmp = new Modelo_DocumentacionEmpleado();
        docEmp = DAO.consultaIdDocEmp(id);
        limpiar();
        ...
        cbEmpleado.setSelectedIndex(docEmp.getIdEmpleado()-1);
            Object value = tbDoc.getValueAt(row, column);
            if (value instanceof JButton) {
                ...
                if (boton.getText().equals("Vacio")) {
                    ...
                    t.ejecutar_archivoPDF(id);
                    try {
                        Desktop.getDesktop().open(new File("Nomina.pdf"));
                    } catch (Exception ex) {
                    }
                }
